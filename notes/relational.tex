...
\begin{mathpar}
  ...
  \inferrule*[left=Weaken]{\inferrule*[Left=Catch]{\inferrule*[Left=Bind]{\crelsyn{}{\ret^\Mone \false}{?w_1}{\aux l_2}{?w_2}{}}
  {\crelsyn{}{\aux l_1; \ret^\Mone false}{?w_1}{\aux l_2}{?w_2}
  {\lambda \varphi . (\varphi(\None, \true) \wedge \varphi(\Some (), \false))(\lambda | (\Inl b_1, b_2) \rightarrow \varphi(\Inl b_1, b_2)
