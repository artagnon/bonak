\providecommand{\lab}{fulltab:idcoh}
\begin{eqntable}{Identity for $q$-th projection and $q$-th degeneracy\label{\lab}}
  ...
  \eqnline{\cohidf[n][p+1][][q][r][\epsilon][\omega]}{\D~(\pair{\d}{\l})}{\defeq}{(\cohf[n][p][][q+1][r+1][\epsilon][\omega][D=\D, d=\d], \cohl[n-1][p][][q][r][\epsilon][\omega][D=\D, d=\d, l=\l])}
  \midrule
