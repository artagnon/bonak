...
\qquad  restrFrame^{n+1,p,q}_{\epsilon} (depRestrFrames^{n+2,p}(C).2[r,\omega](d)) =
    ...
    \!\!\!\colorbox{green}{$
      \!\!\!
      \begin{array}{l}
        \colorbox{olive}{$restrFrames^{n+2,p\leq n+1}:restrFrameTypes^{n+2,p}$} \rocq{RestrFrames}\\
        \quad restrFrames^{n+2,p\leq n+1}\defeq \downarrow_p (depRestrFrames^{n+2,n+1}(fullCohFrames^{n+2}))\\
        \colorbox{olive}{$restrFrames_{aux}^{n+2,p\leq n+1}:restrFrameTypes^{n+2,p}$} \rocq{RestrFrames2}\\
