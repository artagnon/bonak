...
{$
  \begin{array}{|l|}
    ...
    \!\!\!\colorbox{green}{$
      \!\!\!
      \begin{array}{l}
        \colorbox{olive}{$cohFrameTypes^{n+2,p\leq n+1}:\Type$}\\ 
...
\qquad  restrFrame^{n+1,p,q}_{\epsilon} (depRestrFrames^{n+2,p}(C).2[r,\omega](d)) =
        ...
        \colorbox{olive}{$depRestrFrames^{n+2,p\leq n+1}(C:cohFrameTypes^{n+2,p\leq n+1}):restrFrameTypes^{n+2,p}$}\\
    ...
    \!\!\!\colorbox{green}{$
      \!\!\!
      \begin{array}{l}
        \colorbox{olive}{$cohFrames^{n+2,p\leq n}:cohFrameTypes^{n+2,p}$}\rocq{mkCohFramesFromFull}[\mbox{to inline?}]\\
        \quad cohFrames^{n+2}\defeq \downarrow_p fullCohFrames^{n+2}\\
        \colorbox{olive}{$fullRestrFrames^{n+2}:restrFrameTypes^{n+2,n+2}$}\rocq{mkFullRestrFrames}[\mbox{to inline?}]\\
        \quad fullRestrFrames^{n+2}\defeq depRestrFrames^{n+2,n+1}(fullCohFrames^{n+2})\\
        \colorbox{olive}{$restrFrames^{n+2,p\leq n+1}:restrFrameTypes^{n+2,p}$}\\
        \quad restrFrames^{n+2,p\leq n+1}\defeq \downarrow_p fullRestrFrames^{n+2}\\
        \colorbox{olive}{$restrFrames_{aux}^{n+2,p\leq n+1}:restrFrameTypes^{n+2,p}$}\\
        \quad restrFrames_{aux}^{n+2,p\leq n+1}\defeq depRestrFrames^{n+2,p}(cohFrames^{n+2,p})\\
        ...
        \quad restrPainting^{n+2,n+2}_{\epsilon}(E)(d)(l,c)\defeq l_{\epsilon}\\
        \quad restrPainting^{n+2,p}_{\epsilon}(E)(d)(l,c)\defeq (\lambda \omega.\,\overrightarrow{cohFrame_{\epsilon,\omega}^{n+2,p,q}(d)}(restrPainting^{n+1,p}_{\epsilon}(l))),restrPainting^{n+2,p+1}_{\epsilon}(E)(d,l)(c))\\
        ...
        \quad restrPainting_{aux,\epsilon}^{n+2,n+2}(E)(d)(l,c)\defeq l_{\epsilon}\\
        \quad restrPainting_{aux,\epsilon}^{n+2,p}(E)(d)(l,c)\defeq (\lambda \omega.\,\overrightarrow{cohFrame_{aux,\epsilon,\omega}^{n+2,p,q}(d)}(restrPainting^{n+1,p}_{\epsilon}(l))),restrPainting_{aux,\epsilon}^{n+2,p+1}(E)(d,l)(c))\\
      \end{array}
    $}\!\!\!\\
    \!\!\!\colorbox{yellow}{$
      \!\!\!
