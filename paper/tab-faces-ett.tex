...
\begin{eqntable}{$q$-th projection of $\mathsf{restr}$, or faces\label{\lab}}
  ...
  \eqnline{\restrp[m][\epsilon][q][n][p][q \leq n]}{\makecell{\eqnarg{restrpainting}{D}{\Xto{m}{n+1+p}} \\ \eqnarg{restrpainting}{E}{\Xcomp{m}{n+1+p}[D=\D]} \\\eqnarg{restrpainting}{d}{\framep[m][n+1][p][][D=\D]} \\ \eqnarg{restrpainting}{c}{\painting[m][n+1][p][][D=\D, E=\E, d=\d]}}}{:}{\painting[m][n][p][][D=\hdD, E=\tlD, d={\restrf[m][\epsilon][q][n][p][][D=\D, d=\d]}]}
