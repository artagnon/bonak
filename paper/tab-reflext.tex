...
\begin{eqntable}{$q$-th degeneracies above\label{\lab}}
  ...
  \eqnline{\reflfext[n][p+1][][q]}{D~L~\pair{\d}{\l}~c}{\defeq}{\pair{\reflfext[n][p][][q][D=\D, d=\d, c={\l,\c}]}{\refllext[n][p][][q][D=\D, L=\L, d=\d, l=\l, c=\c]}}
  \midrule
  \eqnline{\refllext[n][p][q \leq p < n][q]}{\makecell{\eqnarg{refllayerExt}{D}{\Xreflto{n+1}} \\ \eqnarg{refllayerExt}{L}{\Xreflto{n}(D)} \\ \eqnarg{refllayerExt}{d}{\framep[n][p][][D=\hdD]} \\ \eqnarg{refllayerExt}{l}{\layer[n][p][][D=\D, d=\d]} \\ \eqnarg{refllayerExt}{c}{\painting[n][p+1][][D=\hdD, E=\tlD, d=\d]}}}{:}{\layer[n+1][p+1][][D=\hdD, d={\reflfext[n][p][][q][D=\D, L=\L,  d=\d, c={\l,\c}]}]}
  \eqnline{\refllext[n][p][][q]}{D~d~l~c}{\defeq}{\lambda \omega.(\reflpext[n-1][p][][q][D=\hdD, E=\tlD, d={\reflfext[n][p][][0][\omega][D=\D, L=\L, d=\d, c=\c]}, c={\l_\omega}])}
  \midrule
  ...
  \eqnline{\reflpext[n][p][p<n][q]}{\D~\E~L~R~\d~\pair{l}{c}}{\defeq}{\pair{\refllext[n][p][][q][D=\D, d=\d, l=\l, c=\c]}{\reflpext[n][p+1][][q][D=\D, E=\E, d=\pair{d}{l}, c=\c]}}
\end{eqntable}
