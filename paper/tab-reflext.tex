...
\begin{eqntable}{$q$-th degeneracies above\label{\lab}}
  ...
  \eqnline{\reflfext[n][p+1][][q]}{D~L~\pair{d}{l}~c}{\defeq}{\pair{\reflfext[n][p][][q][D=\D, d=\d]\pair{l}{c}}{\refllext[n][p][][q][D=\D, L=\L, d=\d, l=\l, c=\c]}}
  \midrule
  \eqnline{\refllext[n][p][q \leq p < n][q]}{\makecell{\eqnarg{refllayerExt}{D}{\Xreflto{n+1}} \\ \eqnarg{refllayerExt}{L}{\Xreflto{n}(D)} \\ \eqnarg{refllayerExt}{d}{\framep[n][p][][D=\hdD]} \\ \eqnarg{refllayerExt}{l}{\layer[n][p][][D=\D, d=\d]} \\ \eqnarg{refllayerExt}{c}{\painting[n][p][][D=\hdD, E=\tlD, d=\d]}}}{:}{\layer[n+1][p+1][][D=\hdD, d={\reflfext[n][p][][q][D=\D, L=\L,  d=\d, c=\c]}]}
