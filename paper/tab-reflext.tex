...
\begin{eqntable}{$q$-th degeneracies above\label{\lab}}
  ...
  \eqnline{\refllext[n][p][][q]}{D~d~\pair{l}{c}}{\defeq}{\lambda \omega.(\reflpext[n-1][p][][q][D=\hdD, E=\tlD, d={\reflfext[n][p][][0][\omega][D=\D, L=\L, d=\d, c=\c]}, L=\hdL, R=\tlL, c={\l_\omega}])}
  \midrule
  ...
  \eqnline{\reflpext[n][p][p<n][q]}{\D~\E'~L~R~\d~\pair{l}{c}}{\defeq}{\pair{\refllext[n][p][][q][D=\D, d=\d, c={\l,\c}]}{\reflpext[n][p+1][][q][D=\D, E=\E, R=\R, d=\pair{d}{l}, c=\c]}}
\end{eqntable}
