...
\begin{eqntable}{Commutation of $q$-th projection and $r$-th projection, or coherence conditions\label\lab}
  ...
  \eqnline{\cohc[m][\epsilon][\omega][q][r][n][p][p \leq r \leq q \leq n - 2]}{\makecell{\eqnarg{cohfiller}{D}{\Xto{m}{n}} \\ \eqnarg{cohfiller}{E}{\Xcomp{m}{n}[D=\D]} \\ \eqnarg{cohfiller}{d}{\framep[m][n][p][][D=\D]} \\ \eqnarg{cohfiller}{c}{\filler[m][n][p][][D=\D, E=\E, d=\d]}}}{:}{\makecell{\restrc[m][\epsilon][q][n-1][p][][D=\hdD, E=\tlD, d={\restrf[m][\omega][r][n][p][][D=\D, d=\d]}, c={\restrc[m][\omega][r][n][p][][D=\D, E=\E, d=\d, c=\c]}] \\ \eqHSet \restrc[m][\omega][r][n-1][p][][D=\hdD, E=\tlD, D={\restrf[m][\epsilon][q+1][n][p][][D=\D, d=\d]}, c={\restrc[m][\epsilon][q+1][n][p][][D=\D, E=\E, d=\d, c=\c]}]}}
