...
Let us call $\nu$-sets, the generalization of augmented semi-simplicial sets and semi-cubical sets. To obtain this, we extend $\DeltaPlus$ and $\Cube$ in a straightforward manner into a category which we call $\hexagon$.
  ...
  \begin{figure}[H]
    ...
    \begin{align*}
      ...
      \begin{cases}
        ...
        a :: (g' \circ f') & \text{if $g = (\kstar :: g')$, $f = (a :: f')$, where $a $ or $\kstar$} \\
      \end{cases}               \\
