...
$\depstype[n][\lbrack 0,p-1 \rbrack]$:
...
\begin{equation*}
  \begin{array}{llcl}
    \painting[n+1][\lbrack 0,p-1 \rbrack] &
    \fulldeps[n]                          & :      & \paintingtype[n+1][\lbrack 0,p-1 \rbrack](\framep[n+1][\lbrack 0,p-1 \rbrack](\fulldeps.\deps[n][\lbrack 0,p-1 \rbrack])) \\
    \painting[n+1]                        &
...
\begin{equation*}
  \begin{array}{llcl}
    ...
    \fulldepscohs[n]                    & :      & \restrptype[n+1][\lbrack 0,p-1 \rbrack](\fulldepscohs.\depscohs.\fulldeps[n])) \\
    \restrp[n+1]                        &
...
\begin{equation*}
  \begin{array}{llcl}
    ...
    \fulldepscoht[n]                  & :      & \cohptype[n+1][\lbrack 0,p-1 \rbrack](\fulldepscoht.\depscoht.\fulldepscohs[n])) \\
    \cohp[n+1]                        &
    \fulldepscohs[n]                  & \defeq & \unittype                                                                        \\
