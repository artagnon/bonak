...
\begin{equation*}
  ...
  \end{array}
\end{equation*}
which can be reformulated using sequences for appropriate definitions of $\frametype[n][\lbrack 0,p \rbrack] \defeq $, $\paintingtype[n][\lbrack 0,p \rbrack]$ and $\restrftype[n][\lbrack 0,p \rbrack]$:
\begin{equation*}
  \begin{array}{lcl}
