...
\begin{abstract}
  ...
  The current work analyses the very dependent recursive structure of the equations of the earlier paper leading to a presentation of the construction replacing equational reasoning with definitional reasoning. The construction has been reduced to its computational essence, and can be described in full detail, closely following the new machine-checked formalisation.
\end{abstract}
