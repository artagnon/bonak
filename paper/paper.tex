  ...
  \XKV@for@o\XKV@fams\XKV@tfam{
    ...
    \XKV@for@o{\bonak@mask}\XKV@tempa{
      \IfBeginWith{\XKV@tempa}{\bonak@hdr}{
        \XKV@delete#2{\StrBehind{\XKV@tempa}{\bonak@hdr}}\XKV@getkeyname}{}
    }
  }
...
\makeatletter
\def\XKV@fams{frame,layer,filler}
\def\bonak@keys{D=D,E=E,d=d}
...
\long\def\bonak@delete#1#2#3{
  ...
  \XKV@for@o\XKV@tempb\XKV@tempb{
    ...
    \ifmember{,\XKV@tempc,}{,\XKV@tempa,}{}{\XKV@addtolist@o#1\XKV@tempb}
  }
}
\XKV@for@o\XKV@fams\XKV@tfam{
  \def\bonak@hdr{\XKV@prefix\XKV@tfam @}
  \XKV@for@o{\bonak@mask}\XKV@tempc{
    \IfBeginWith{\XKV@tempc}{\bonak@hdr}{
      \bonak@delete\bonak@keys{\StrBehind{\XKV@tempc}{\bonak@hdr}} \XKV@getkeyname
    }{}
  }
}
\makeatother
