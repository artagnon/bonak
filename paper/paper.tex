...
\usepackage{multirow, minted, tabularx, environ, booktabs, setspace, makecell, caption, xkeyval, xstring, stringstrings, ifthen, pdflscape}
    ...
    \XKV@for@o\bonak@mask\XKV@tempa{
      ...
      \ifthenelse{\equal{\theresult}{0}}{}
      {
        ...
        \XKV@for@o\XKV@tempb\XKV@tempb{
          ...
          \else
            % Unmasked keys
            \XKV@addtolist@x\XKV@resb\XKV@tempc
          \fi
        }
...
\newcommandx{\prim}[6][2,3,4,5,6]{
  \mathsf{\color{indian-yellow}{#1}}_{#2}^{
    \joinargs{}[#3][#4][#5]}
  \setkeys*[bonak]{#1}{#6}
}
...
\newcommandx{\restr}[8][2,3,4,5,6,7,8]{
  \mathsf{\color{russian-green}{restr}}_{
