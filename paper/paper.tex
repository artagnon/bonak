...
\begin{eqntable}{Truncated sets, the core\label{tab:core}}
  ...
  \eqnline{\Xcomp{l}{n}}{(D:\X{l}{n})}{:}{\sort{l}}
  \eqnline{\Xcomp{l}{n}}{D}{\defeq}{\fullframe{l}{n}\D\imp \sort{l}}
\end{eqntable}

\begin{eqntable}{$\mathsf{frame}, \mathsf{layer}, \mathsf{filler}$\label{tab:frames}}
  \mc{Full $n$-frames}
  \eqnline{\fullframe{l}{n}}{(D:\X{l}{n})}{:}{\sort{l}}
  \eqnline{\fullframe{l}{n}}{D}{\defeq}{\framep{l}{n,n}\D}

  \\

  \mc{Partial $n$-frames, $n$-layers, and $n$-fillers}
  \eqnline{\framep{l}{n,p,[p \leq n]}}{(D:\X{l}{n})}{:}{\sort{l}}
  \eqnline{\framep{l}{n,0}}{D}{\defeq}{\unittype}
  \eqnline{\framep{l}{n,p'+1}}{D}{\defeq}{\Sigma d:\framep{l}{n,p'}\D.\,\layer{l}{n,p'} \D \d}

  \\

  \eqnline{\layer{l}{n,p,[p < n]}}{\makecell{(D:\X{l}{n}) \\ (d:\framep{l}{n,p} \D)}}{:}{\sort{l}}
  ...
  \eqnline{\filler{l}{n,p,[p \leq n]}}{\makecell{(D:\X{l}{n}) \\(E:\Xcomp{l}{n} \D) \\ (d:\framep{l}{n,p} \D)}}{:}{\sort{l}}
...
\begin{eqntable}{Coinductive structure\label{tab:coind}}
  \eqnline{\Xp{l}}{}{:}{\sort{l+1}}
  \eqnline{\Xp{l}}{}{\defeq}{\Xfrom{l}{0}(\star)}
  \\
  \eqnline{\Xfrom{l}{n}}{(D:\X{l}{n})}{:}{\sort{l+1}}
