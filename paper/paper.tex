...
\begin{align*}
  ...
  \seqr{}{\Gamma, a:A \vdash D(a) : \Type_m \qquad \Gamma, a:A, d:D(a) \vdash v(a,d) : B(a,d) \qquad \Gamma, a:A, d:D(a) \vdash s(a,d) : Stream_{A,B,f}\,f(a,v(a,d)) \qquad \Gamma \vdash u : A \qquad \Gamma \vdash d : D(a)}{\Gamma \vdash \{this:=v; next:=s\} : Stream_{A,B,f}\, u} \\
