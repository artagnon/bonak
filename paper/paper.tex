...
For $\nu$ an arity, that is $1$ in the case of predicates, families and augmented semi-simplicial sets, or $2$ in the case of relations, correspondences and semi-cubical sets, such sequence of was called a $\nu$-set. Equations specifying $\nu$-sets were given in \cite{hr25} with an accompanying formalisation in Rocq. The argument used to justify the well-foundedness of the construction was however heavy. In this paper, we present a refined well-foundedness argument which reflects the recursive essence of the construction.
