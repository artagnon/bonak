...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \begin{array}{l}
        \Pi q\leq n.\Pi r\leq q.\Pi \epsilon.\Pi \omega.\Pi d:\framep(\depscohs[n][0,...,p]). \\
  ...
  \begin{array}{llcl}
    ...
    \begin{array}{l}
        ...
        \left(\begin{array}{l}
                  \depscoht[n][0,...,n].\deps       \\
                  E:\framep[n-1][n-1]\rightarrow \U \\
                \end{array}\right)(\cohf[n][p](\depscoht[n][0,...,n].deps)(d))\end{array}\right)                                                  \\
    \cohp[n][n]                                        &
    \left(\begin{array}{l}
              \depscoht[n][0,...,n] \\
              E                     \\
