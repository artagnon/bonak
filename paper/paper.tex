...
\newcommandx{\depscoht}[2][1,2]{\depsmacro{deps}{coht}{chestnut}[#1][#2]}
\newcommandx{\fulldepscoht}[1][1]{\depsmacro{deps}{fullcoht}{chestnut}[#1]}
...
\newcommandx{\depscohttype}[2][1,2]{\depsmacro{DEPS}{coht}{chestnut}[#1][#2]}
\newcommandx{\fulldepscohttype}[1][1]{\depsmacro{DEPS}{fullcoht}{chestnut}[#1]}
...
\begin{equation*}
  \begin{array}{llcl}
    ...
    \begin{array}{l}
      ...
      \overrightarrow{\cohf[n][p][q][r][\epsilon][\omega]}\restrp[n][p][q][\epsilon](\restrf[n+1][p](\depscohs[n][\lbrack 0,p-1 \rbrack])(d))(\restrp[n+1][p][r][\omega]
      (\fulldepscohs[n])(d)(c)) =                                                                                                                     \\
...
\begin{equation*}
  \begin{array}{llcl}
    ...
    \depscoht[n][\lbrack 0,p-1 \rbrack]         & \defeq                              &
    \lambda d. \lambda l. \lambda \theta. \overrightarrow{\coht[n][p][q][r][\epsilon][\omega][\theta](\fulldepscohs[n])}                                                                                                                                                                                                                      \\
                                                &                                     &                                                                                   & (\ap \overrightarrow{\cohf[n][p][r][0][\omega][\theta]} \ap \overrightarrow{\cohf[n][p][q+1][0][\epsilon][\theta]} \cohp[n][p][q][r][\epsilon][\omega](l_\theta)) \\
  \end{array}
\end{equation*}
where $\cohttype$ is:
\begin{equation*}
  ...
  \begin{array}{l}
    ...
    \cohf[n][p][r][0][\omega][\theta](\restrf[n+2][p][q+2][\epsilon](\overline{\depscohs}(\depscoht[n][\lbrack 0,p \rbrack]))) \circ \\
    \ap\restrf[n][p][r][\omega](\cohf[n+1][p][q+1][0][\epsilon][\theta]
    (\depscoht[n][p]))
    \circ                                                                                                                            \\
    \cohf[n][p][q][r][\epsilon][\omega](\restrf[n+2][p][0][\theta](\overline{\depscohs}(\depscoht[n][\lbrack 0,p \rbrack]))) =       \\
    \ap\restrf[n][p][0][\theta](\cohf[n+1][p][q+1][r+1][\epsilon][\omega]
    (\depscoht[n][p]))
    \circ                                                                                                                            \\
    \cohf[n][p][q][0][\epsilon][\theta](\restrf[n+2][p][r+1][\omega](\overline{\depscohs}(\depscoht[n][\lbrack 0,p \rbrack])))
    \circ                                                                                                                            \\
    \ap\restrf[n][p][q][\epsilon](\cohf[n+1][p][r][0][\omega][\theta]
    (\depscoht[n][p]))
  \end{array}
\end{equation*}
and where the functoriality of equality and transport was used to go from:
\begin{equation*}
  \begin{array}{lcl}
    \begin{array}{l}
      \overrightarrow{\cohf[n][p][r][0][\omega][\theta]}\overrightarrow{\cohf[n][p][q+1][0][\epsilon][\theta]} \\
      \overrightarrow{\cohf[n][p][q][r][\epsilon][\omega]}\restrp[n][p][q][\epsilon]                           \\
      (\restrf[n+1][p](\depscohs[n][\lbrack 0,p-1 \rbrack])(d))                                                \\
      (\restrp[n+1][p][r][\omega](\fulldepscohs[n])(d)(c))
    \end{array} & = &
    \begin{array}{l}
      \overrightarrow{\cohf[n][p][r][0][\omega][\theta]}\overrightarrow{\cohf[n][p][q+1][0][\epsilon][\theta]} \\
      \restrp[n][p][r][\omega](\restrf[n+1][p](\depscohs[n][\lbrack 0,p-1 \rbrack])(d))                        \\
      (\restrp[n+1][p][q+1][\epsilon](\fulldepscohs[n])(d)(c))
    \end{array}
  \end{array}
\end{equation*}
to
\begin{equation*}
  \begin{array}{lcl}
    \begin{array}{l}
      \overrightarrow{\cohf[n][p][r][0][\omega][\theta]}\overrightarrow{\cohf[n][p][q+1][0][\epsilon][\theta]} \\
      \restrp[n][p][q][\epsilon](\restrf[n+1][p](\depscohs[n][\lbrack 0,p-1 \rbrack])(d))                      \\
      (\overrightarrow{\cohf[n][p][q][r][\epsilon][\omega]}\restrp[n+1][p][r][\omega](\fulldepscohs[n])(d)(c))
    \end{array} & = &
    \begin{array}{l}
      \overrightarrow{\cohf[n][p][r][0][\omega][\theta]}                                \\
      \restrp[n][p][r][\omega](\restrf[n+1][p](\depscohs[n][\lbrack 0,p-1 \rbrack])(d)) \\
      (\overrightarrow{\cohf[n][p][q+1][0][\epsilon][\theta]}\restrp[n+1][p][q+1][\epsilon](\fulldepscohs[n])(d)(c))
    \end{array}
  \end{array}
\end{equation*}
