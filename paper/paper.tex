...
\maketitle
\begin{abstract}
  In an exploration of building simplicial and cubical set models in indexed form, we extend a previous construction of semi-simplicial and semi-cubical sets with degeneracies. The degeneracies we construct can be characterized as adding a new dimension, and coincide with usual degeneracies in the cubical set case. As necessitated by the construction, we refined the degeneracies and coherence conditions outlined in Grandis-Mauri~\cite{grandis03} to make it step-wise for partial constructions. Our work includes a mechanically checked formalization in Rocq.
\end{abstract}

\section{Introduction}
\subsection{Motivation}
Simplicial and cubical sets are defined as presheaves over simplicial and cubical categories, which we term as \emph{fibred form}. Our construction, in contrast, experiments using the \emph{indexed form}, using the \emph{fibred-indexed correspondence}. It was originally suggested at Univalent Foundations IAS 2012~\cite{UFwiki2012}. The original motivation for the indexed construction is that it suggests that the open problem of constructing simplicial and cubical types could be solved with this approach, as it supplies more definitional equalities for tackling the combinatorial problem of solving coherence conditions~\footnote{It was originally postulated that the coherences would come for free with the indexed construction, but this turns out not to be the case.}. Another motivation is constructing simplicial and cubical set models, such as parametric type theory and cubical type theory with more definitional equalities.

\subsection{Contributions}
We previously exploited the observation that semi-simplicial and semi-cubical sets are naturally unary and binary cases of iterated parametricity~\cite{hr25}. In adding a new dimension to our construction, we observed the usual cubical degeneracies in the cubical case and \emph{connections}~\cite{bernardy12,bernardy15} in the simplicial case. The coherence conditions we used to complete our construction made explicit the ones outlined in Grandis-Mauri~\cite{grandis03}. Our work includes a mechanically-checked formalization in Rocq: \href{https://github.com/artagnon/bonak}{github.com/artagnon/bonak}.

\subsection{Fibred-indexed correspondence}

Semi-simplicial sets and semi-cubical sets can be expressed directly in terms of presheaves over a direct category using morphisms or alternatively using families, by iterating the standard equivalence between maps and families:
...
Both definitions are provably equivalent using univalence~\cite{Laroche} and this is yet another instance of the \emph{Grothendieck construction}, which we refer to as the fibred-indexed correspondence.

Presheaves over a generalised Reedy category can also be expressed in the indexed form, thus covering the case of simplicial and cubical sets.
...
\begin{equation*}
  \begin{array}{cllccllll}
    ...
    r^1_1                                                    & :                     & \Pi (x^0_{L},x^0_{R}):(X_0 \times X_0).\,\Pi x^1:X_1(x^0_L,x^0_R).\,                                                                                                                                                                                                               \\
                                                             ...
                                                             &                       &                                                                      &  &
    coh^1                                                    &                       &
    : \Pi (x^0_{L},x^0_{R}):(X_0 \times X_0).\,\Pi x^1:X_1(x^0_L,x^0_R).\,                                                                                                                                                                                                                                                                                                \\
                                                             &                       &                                                                      &  &                                                                                    &                  & r^1_0 (x^0, x^0,r^0_0 (x^0)) = r^1_1 (x^0,x^0,r^0_0 (x^0))                                       \\
