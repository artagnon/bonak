...
\usepackage{amsthm, amssymb, amsaddr, fancyhdr, bookmark, fontspec, xargs, multirow, polyglossia, luacode, listings, color, soulutf8, tcolorbox, tabularx, tikz-cd, booktabs, setspace, makecell, caption, floatrow, mathrsfs, xpatch, lmodern}
...
Cubical type theory is an extension of dependent type theory that provides a computational interpretation of Voevodsky's \emph{univalence axiom}. Several strides in the field have been made since \cite{Bezem14} in constructing a model of type theory for cubical sets, and we present another approach to the construction, with a sound motivation. Although our work is motivated by homotopy type theory, construction of the \emph{path type} and \emph{transport} are beyond the scope of our work; we merely formalize semi-cubical sets. Our secondary contribution is a mechanically checked proof of our construction in Coq~\footnote{\href{https://github.com/artagnon/bonak}{github.com/artagnon/bonak}}.
