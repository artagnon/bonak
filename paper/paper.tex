...
\makeatletter
\newcommandx{\prim}[6][2=,3=,4=,5=,6=]{\ensuremath{\mathsf{\color{indian-yellow}{#1}}_{#2}^{\joinargs{}[#3][#4][#5]}}\@ifstar{}{\setkeys*{prim-#1}{#6}}}
\makeatother

% Restriction for frame, layer, and filler: the general macro
\makeatletter
\newcommandx{\restr}[8][2=,3=,4=,5=,6=,7=,8=]{\ensuremath{\mathsf{\color{russian-green}{restr}}_{\mathsf{\color{indian-yellow}{#1}}\joinargs{,}[#2][#3][#4]}^{\joinargs{}[#5][#6][#7]}}\@ifstar{}{\setkeys*{restr-#1}{#8}}}
\makeatother
...
\makeatletter
\newcommandx{\coh}[9][2=,3=,4=,5=,6=,7=,8=,9=]{\ensuremath{\mathsf{\color{chestnut}{coh}}_{\mathsf{\color{indian-yellow}{#1}}\joinargs{,}[#2][#3][#4][#5][#6]}^{\joinargs{}[#7][#8]}}\@ifstar{}{\setkeys*{coh-#1}{#9}}}
\makeatother
