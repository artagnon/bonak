...
\newcommandx{\cohid}[9][2,3,4,5,6,7,8]{
  \ensuremath{\mathsf{\color{chestnut}{cohid}}^{
    \joinargs[#2][#3][#4]}_{\joinargs[\mathsf{\color{indian-yellow}{#1}}][#5][#6][#7]}}
  \setkeys*[bonak]{cohid#1}{#8}
}
...
\newcommandx{\cohidf}[7][1,2,3,4,5,6,7]{\cohid{frame}[#1][#2][#3][#4][#5][#6][#7]}
\newcommandx{\cohidl}[7][1,2,3,4,5,6,7]{\cohid{layer}[#1][#2][#3][#4][#5][#6][#7]}
\newcommandx{\cohidp}[7][1,2,3,4,5,6,7]{\cohid{painting}[#1][#2][#3][#4][#5][#6][#7]}
