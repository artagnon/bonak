...
% Coherence conditions for frame, layer, and filler
\renewcommandx{\cohframe}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{cohframe}[][#2][#3][#4][#5][][#7][#8]}
\renewcommandx{\cohlayer}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{cohlayer}[][#2][#3][#4][#5][][#7][#8]}
\renewcommandx{\cohfiller}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{cohfiller}[][#2][#3][#4][#5][][#7][#8]}
