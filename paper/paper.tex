...
\begin{align*}
  ...
  \cohf[n][p]        & : \Pi qr\epsilon\omega.\, \restrf[n-1][p][q][\epsilon] \circ \restrf[n][p][\omega][r] =                                                           \\
                     & \;\;\;\;\restrf[n-1][p][r][\omega] \circ \restrf[n][p][\epsilon][q+1]                                                & \mbox{for all $p\leq n$}   \\
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \depscohs[n][\lbrack 0,p \rbrack]       & \defeq                              &
    \lambda d.\lambda l.\lambda \omega\overrightarrow{\cohf[n][p][q][0][\epsilon][\omega](d)}{\restrp[n][p][q][\epsilon](\restrf[n][p][q][\epsilon](\depscohs[n][\lbrack 0,p-1 \rbrack])(d))(l_\omega)} \\
  \end{array}
\end{equation*}
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    (\depscoht[n][\lbrack 0,p-1 \rbrack])                                         & \defeq                                                                        &
    \lambda d. \lambda l. \lambda \theta. \overrightarrow{\coht[n][p][q][r][\epsilon][\omega][\theta](\depscoht.\fulldepscohs[n])}{(\depscoht.\cohp[n][p][q][r][\epsilon][\omega](l_\theta))}                                                                                                   \\
  \end{array}
\end{equation*}
...
\begin{align*}
  ...
  \begin{array}{l}
    ...
    \end{array}\right)                                                                                                                                   \\
  \fulldeps[n](E: \framep[n+1][n](\deps[n][\lbrack 0,n-1 \rbrack])\rightarrow \U) & \defeq &
  \left(
  \begin{array}{l}
      \framep[n][\lbrack 0,n-1 \rbrack]   \\
      \painting[n][\lbrack 0,n-1 \rbrack] \\
      \restrf[n][\lbrack 0,n-1 \rbrack]   \\
      E                                   \\
    \end{array}\right)                                                                                                                                   \\
  ...
  \fulldepscohs[n]
  \left(\begin{array}{l}
            E: \framep[n+1][n](\deps[n][\lbrack 0,n-1 \rbrack])\rightarrow \U \\
            E': \framep[n+2][n](\deps[n][\lbrack 0,n \rbrack])\rightarrow \U  \\
          \end{array}\right)            & \defeq &
  \left(
  \begin{array}{l}
      \fulldeps[n](E)                      \\
      \restrp[n][\lbrack 0,n-1 \rbrack](E) \\
      \cohf[n][\lbrack 0,n-1 \rbrack](E)   \\
      E'                                   \\
    \end{array}\right)                                                                                                                                  \\
