...
\newcommandx{\frametype}[2][1,2]{\prim{frametype}[][][#2][][]}
\newcommandx{\layer}[2][1,2]{\prim{layer}[][#1][#2][][]}
\newcommandx{\painting}[2][1,2]{\prim{painting}[][#1][#2][][]}
\newcommandx{\paintingtype}[2][1,2]{\prim{paintingtype}[][][#2][][]}
\newcommandx{\restrftype}[2][1,2]{\prim{restrftype}[][][#2][][]}
  ...
  \begin{array}{llcl}
    ...
    \begin{array}{l}
      ...
      \left(\begin{array}{l}
                ...
                \painting[n+1][0,...,p-1] \\
              \end{array}\right)                         .  \\
      \Pi q\leq n.\,\Pi \omega.\,\framep[n][p]
      \left(\begin{array}{l}
                \framep[n][0,...,p-1]     \\
                \painting[n-1][0,...,p-1] \\
                \restrf[n][0,...,p-1]     \\
