...
\newcommandx{\myframe}[2][1,2]{\prim{frame}[][#1][#2][#2][]}
  ...
  \begin{array}{l}
    ...
    \framebox{$\begin{array}{lll}
                     \overbrace{\raisebox{0.05cm}{\framebox{$
                           \begin{array}{ll}
                  \raisebox{0cm}{\hspace{.5cm}{\scriptsize$\mylayer[1][0]$}} & \framebox{$a_{0\unitpoint}$} \\
                  [1mm]\overbrace{\framebox{$a_{00}$}~\framebox{$a_{01}$}}   &
                  \raisebox{-0.1cm}{{\scriptsize \hspace{0.1cm}$\myfiller[1][0]\!\!\!\!\!\!\!\!$}}
                  \\
                \end{array}
                         $}}~
                     {\raisebox{0.05cm}{\framebox{$
                           \begin{array}{ll}
                  \raisebox{0cm}{\hspace{.5cm}{\scriptsize$\mylayer[1][0]$}} & \framebox{$a_{1\unitpoint}$} \\
                  [1mm]\overbrace{\framebox{$a_{10}$}~\framebox{$a_{11}$}}   &
                  \raisebox{-0.1cm}{{\scriptsize \hspace{0.1cm}$\myfiller[1][0]\!\!\!\!\!\!\!\!$}}
                \end{array}
                         $}}}}^{\mylayer[2][0]}~\stackrel{\raisebox{9.5mm}{$\framebox{$
                               \begin{array}{ll}
                      \raisebox{0cm}{\hspace{.5cm}{\scriptsize$\mylayer[2][1]$}}                   & \framebox{$a_{\unitpoint\unitpoint}$} \\
                      [1mm]\overbrace{\framebox{$a_{\unitpoint 0}$}~\framebox{$a_{\unitpoint 1}$}} &
                      \raisebox{-0.1cm}{{\scriptsize \hspace{0.1cm}$\myfiller[2][1]\!\!\!\!\!\!\!\!$}}
                    \end{array}$}$}}
                     {\raisebox{-0.4cm}{{\scriptsize \hspace{2.5cm}$\myfiller[2][0]\!\!\!\!\!\!\!$}}}
                   \end{array}$}
    ~~~\parbox{3.5cm}{{\it additionally, each atomic component at dimension $n$ is a $\myfiller[n][n]$}} \\
    [-1mm]\qquad\qquad~~
    \begin{tikzcd}
      \bullet\arrow[r, leftrightarrow] & \bullet\\
    \end{tikzcd}
    \mbox{\normalsize $\myframe[1][1]$}
    \quad~~
    \begin{tikzcd}
      \bullet\arrow[r, leftrightarrow] & \bullet \\
    \end{tikzcd}
    ...
    \begin{tikzcd}
     \bullet\arrow[r, leftrightarrow] & \bullet\\
    \end{tikzcd}
    \mbox{\normalsize$\myframe[2][1]$}                                                                   \\
    [-2mm]\qquad\qquad
    \begin{tikzcd}
      \bullet\arrow[r, leftrightarrow] & \bullet\\
    \end{tikzcd}
    \mbox{\normalsize$\myframe[2][2]$}                                                                   \\
  \end{array}
\end{equation*}
