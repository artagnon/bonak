...
Frames are defined mutually with the types of frame restrictions,
using auxiliary definitions for the types and definitions of layers:
\begin{equation*}
  \fontsize{7.2}{9}\selectfont
  \begin{array}{llcl}
    \framep[n+1][0,...,(p+1)-1]                                                                    &
...
\\
    ...
    \left(\begin{array}{l}
              ...
              \cohf[n][0,...,p]     \\
            \end{array}\right)
    & \defeq & \Pi q \leq n. \Pi \epsilon. \Pi d: \framep[n+1][p]
    \left(
        \begin{array}{l}
