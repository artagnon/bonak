...
\begin{align*}
  ...
  \seqr{}{\!\!\!\begin{array}{l}\Gamma \vdash A : \Type_m \qquad \Gamma, a:A \vdash B(a) : \Type_m \qquad \Gamma, a:A, b:B(a) \vdash f(a,b):A\\ \Gamma, a:A \vdash D(a) : \Type_m \qquad \\ \Gamma, a:A, d:D(a) \vdash v(a,d) : B(a) \qquad \Gamma, a:A, d:D(a) \vdash s(a,d) : D(f(a,v(a,d))) \qquad \\ \Gamma \vdash u : A \qquad \Gamma \vdash w : D(u)\end{array}}{\Gamma \vdash \textsf{cofix}_{a,d,g}^{u,w}\{this:=v(a,d); next:=g(f(a,v(a,d)),s(a,d))\} : Stream_{A,B,f}\, u} \\
  \seqr{}{\Gamma \vdash t : Stream_{A,B,f}\, u}{\Gamma \vdash t.this : B(u)}                                                                                                                                                                                                            \\
  \seqr{}{\Gamma \vdash t : Stream_{A,B,f}\, u}{\Gamma \vdash t.next : Stream_{A,B,f}\, f(u,v(u,s(u,t.this)))}                                                                                                                                                                                \\
  \mbox{\emph{computation}}                                                                                                                                                                                                                                                             \\
  \seqr{}{\!\!\!\begin{array}{l}\Gamma \vdash A : \Type_m \qquad \Gamma, a:A \vdash B(a) : \Type_m \qquad \Gamma, a:A, b:B(a) \vdash f(a,b):A\\\Gamma, a:A \vdash D(a) : \Type_m \qquad \\ \Gamma, a:A, d:D(a) \vdash v(a,d) : B(a) \qquad \Gamma, a:A, d:D(a) \vdash s(a,d) : D(f(a,v(a,d))) \qquad \\ \Gamma \vdash u : A \qquad \Gamma \vdash w : D(u)\end{array}}{\Gamma \vdash \textsf{cofix}_{a,d,g}^{u,w}\{this:=v(a,d); next:=g(f(a,v(a,d)),s(a,d))\}.this \equiv v : B(u)}                                                                                                                   \\
  \seqr{}{\!\!\!\begin{array}{l}\Gamma \vdash A : \Type_m \qquad \Gamma, a:A \vdash B(a) : \Type_m \qquad \Gamma, a:A, b:B(a) \vdash f(a,b):A\\\Gamma, a:A \vdash D(a) : \Type_m \qquad \\ \Gamma, a:A, d:D(a) \vdash v(a,d) : B(a) \qquad \Gamma, a:A, d:D(a) \vdash s(a,d) : D(f(a,v(a,d))) \qquad \\ \Gamma \vdash u : A \qquad \Gamma \vdash w : D(u)\end{array}}{\!\!\!\begin{array}{r}\Gamma \vdash \textsf{cofix}_{a,d,g}^{u,w}\{this:=v(a,d); next:=g(f(a,v(a,d)),s(a,d))\}.next \equiv \\ \textsf{cofix}_{a,d,g}^{f(u,v(u,w)),s(u,w))}\{this:=v(a,d); next:=g(f(a,v(a,d)),s(a,d))\} : Stream_{A,B,f}\,f(u,v(u,w))\end{array}}                                                                                                 \\
\end{align*}
where $\textsf{cofix}_{a,d,g}^{f(u,v(u,w)),s(u,w))}\{this:=v(a,d); next:=g(f(a,v(a,d)),s(a,d))\}$ is a notation for the instantiation on parameter $u$ and seed $w$ of the generic corecursive definition of a stream on $a$ generated by a recipe dependent on seed $d:D(a)$ with first component given by $v(a,d)$ and second component recursively of the form $g(f(a,v(a,d)),s(a,d))$ for $\Gamma, a:A, d:D(a) \vdash g(a,d): Stream_{A,B,f}\, (f(a,d))$ and $s(a,d)$ telling how the seed evolves when producing the second component.
