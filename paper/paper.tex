...
\newcommandx{\fulldepstype}[1][1]{\depstypep{full}[][][][#1][][][]}
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \frametype[n][\lbrack \rbrack]       &  & \defeq & \unittype                                        \\
...
The types $\paintingtype[n][\lbrack 0,p-1 \rbrack]$ of $\painting[n][\lbrack 0,p \rbrack]$ for $p \leq n+1$ are type families over frames, so $\framep[n][\lbrack 0,p-1 \rbrack]$ needs to be assumed beforehand:

\begin{equation*}
  \fontsize{7.2}{9}\selectfont
  \begin{array}{llcl}
    \paintingtype[n][\lbrack 0,p-1 \rbrack] & (\framep[n][\lbrack 0,p \rbrack]:\frametype[n][\lbrack 0,p-1 \rbrack]) & :      & \U                                                                                                                   \\
    \paintingtype[n][\lbrack \rbrack]       & \unitpoint                                                             & \defeq & \unittype                                                                                                            \\
...
restrictions together with $\framep[n+1][\lbrack 0,p-1 \rbrack]$ as a function from
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    \painting[n+1][\lbrack 0,p-1 \rbrack] &
    (\fulldeps[n]:\fulldepstype[n])       & :      & \paintingtype[n+1][\lbrack 0,p-1 \rbrack](\framep[n+1][\lbrack 0,p-1 \rbrack](\fulldeps.\deps[n][\lbrack 0,p-1 \rbrack])) \\
    \painting[n+1][\lbrack \rbrack]       &
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \restrptype[n][\lbrack \rbrack]       & E      & \defeq                                                & \unittype \\
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    (\fulldepscohs[n]:\fulldepscohstype[n]) & :      & \restrptype[n+1][\lbrack 0,p-1 \rbrack](\fulldepscohs.\depscohs.\fulldeps[n])) \\
    \restrp[n+1][\lbrack \rbrack]           &
...
\begin{align*}
  ...
  \begin{array}{llcl}
    ...
    \left(\begin{array}{l}
            ...
            \end{array}\right) & :                                                                             & \U                                                                                                                                                                                          \\
    \cohttype[n][\lbrack \rbrack]                                                            &
    \left(\begin{array}{l}
              (E,E')     \\
              \unitpoint \\
            \end{array}\right)                                                                   & \defeq                                                                        &
    \unittype                                                                                                                                                                                                                                                                                              \\
    \cohttype[n][\lbrack 0,p \rbrack]                                                        &
    \left(\begin{array}{l}
              \fulldepscohs[n]              \\
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \begin{array}{l}
        ...
        (\fulldepscoht.\depscoht.\fulldepscohs[n+1])(d)(c)) =                    \\
...
From which we can deduce $\cohp[n+1][\lbrack 0,p-1 \rbrack]$ for $p \leq n+1$ again by a second recursion, this time on $p$:

\begin{equation*}
  \fontsize{7.2}{9}\selectfont
  \begin{array}{llcl}
    \cohp[n+1][\lbrack 0,p-1 \rbrack]       &
    (\fulldepscoht[n]:\fulldepscohttype[n]) & :      & \cohptype[n+1][\lbrack 0,p-1 \rbrack](\fulldepscoht.\depscoht.\fulldepscohs[n])) \\
    \cohp[n+1][\lbrack \rbrack]             &
    \fulldepscohs[n]                        & \defeq & \unittype                                                                        \\
