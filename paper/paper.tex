...
Iterated parametricity à la Reynolds has the property that it mechanically generates augmented simplicial sets in the unary case and cubical sets in the binary (relational) case (see~\cite{johann17} for the correspondence in the cubical case . This was exploited
Simplicial sets are commonly represented as presheaves over the simplex category. In~\cite{IAS}, the idea was given to represent them instead as families of dependent families.
