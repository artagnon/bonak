...
\mbox{\emph{introduction and eliminations}}\\
  \seqr{}{\Gamma \vdash u : A \qquad \Gamma \vdash v : B(u) \qquad \Gamma \vdash s : Stream_{A,B,f}\,f(u,v)}{\Gamma \vdash \{this:=u; next:=v\} : Stream_{A,B,f}\, u}                                      \\
...
\mbox{\emph{computation}}\\
  \seqr{}{\Gamma \vdash u : A \qquad \Gamma \vdash v : B(u) \qquad \Gamma \vdash s : Stream_{A,B,f}\,f(u,v)}{\Gamma \vdash \{this:=u; next:=v\}.this \equiv u : B(u)}                             \\
  \seqr{}{\Gamma \vdash u : A \qquad \Gamma \vdash v : B(u) \qquad \Gamma \vdash s : Stream_{A,B,f}\,f(u,v)}{\Gamma \vdash \{this:=u; next:=v\}.next \equiv v : Stream_{A,B,f}\,f(u,v)} \\
\end{align*}
