...
\begin{center}
  ...
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \fill[raspeberry, pattern=dots] (1, 1) -- (1.5, 1.5) -- (1.5, 0.5) -- (1, 0) -- (1, 1);
    \fill[raspeberry, pattern=dots] (0, 1) -- (0.5, 1.5) -- (0.5, 0.5) -- (0, 0) -- (0, 1);
  ...
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \fill[russian-green, pattern=dots] (0, 1) -- (1, 1) -- (1.5, 1.5) -- (0.5, 1.5) -- (0, 1);
    \fill[russian-green, pattern=dots] (0, 0) -- (1, 0) -- (1.5, 0.5) -- (0.5, 0.5) -- (0, 0);
  \end{tikzpicture}
\end{center}

\begin{center}
  \begin{tikzpicture}[scale=2]
    \fill[spanish-blue, pattern=dots] (1, 1) -- (1.5, 1.5) -- (1.5, 0.5) -- (1, 0) -- (1, 1);
    \fill[spanish-blue, pattern=dots] (0, 1) -- (0.5, 1.5) -- (0.5, 0.5) -- (0, 0) -- (0, 1);
    \draw[spanish-blue] (1, 1) -- (1, 0);
  ...
  \begin{tikzpicture}[scale=2]
    ...
    \fill[raspeberry, pattern=dots] (0.5, 0.5) -- (1.5, 0.5) -- (1.5, 1.5) -- (0.5, 1.5) -- (0.5, 0.5);
    \draw[raspeberry] (0, 0) -- (1, 0);
    \draw[raspeberry] (1, 1) -- (0, 1);
    \draw[raspeberry] (0.5, 0.5) -- (1.5, 0.5);
    \draw[raspeberry] (1.5, 1.5) -- (0.5, 1.5);
  ...
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \fill[russian-green, pattern=dots] (0, 1) -- (1.0, 1) -- (1.5, 1.5) -- (0.5, 1.5) -- (0, 1);
    \fill[russian-green, pattern=dots] (0, 0) -- (1.0, 0) -- (1.5, 0.5) -- (0.5, 0.5) -- (0, 0);
  \end{tikzpicture}
\end{center}
...
\begin{center}
  ...
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \fill[raspeberry, pattern=dots] (0, 1) -- (1, 1) -- (1.5, 1.5) -- (0.5, 1.5) -- (0, 1);
    \fill[raspeberry, pattern=dots] (0, 0) -- (1.0, 0) -- (1.5, 0.5) -- (0.5, 0.5) -- (0, 0);
    \draw[raspeberry] (0, 1) -- (1, 1);
    \draw[raspeberry] (1.5, 1.5) -- (0.5, 1.5);
    \draw[raspeberry] (0, 0) -- (1, 0);
    \draw[raspeberry] (1.5, 0.5) -- (0.5, 0.5);
  \end{tikzpicture}
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
