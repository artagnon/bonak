...
\usepackage{listings, color, soulutf8, graphicx, tcolorbox, tabularx, tikz, booktabs, setspace}
...
\newcommand{\mybox}[1]{\mathsf{box}_{#1}}
\newcommand{\mylayer}[1]{\mathsf{layer}_{#1}}
\newcommand{\mycube}[1]{\mathsf{\cubeovername}_{#1}}
\newcommand{\downbox}[2]{\mathsf{subbox}_{#1}^{#2}}
\newcommand{\downlayer}[2]{\mathsf{sublayer}_{#1}^{#2}}
\newcommand{\downcube}[2]{\mathsf{subcube}_{#1}^{#2}}
\newcommand{\cohbox}[2]{\mathsf{cohbox}_{{#1}}^{{#2}}}
\newcommand{\cohlayer}[2]{\mathsf{cohlayer}_{#1}^{#2}}
\newcommand{\cohcube}[2]{\mathsf{coh\cubeovername}_{#1,#2}}
...
\newcommand{\depdowncubetype}[2]{\mathsf{Subdep\cubeovername}_{#1}^{#2}}
...
\NewDocumentEnvironment{eqntable}{m}{\table[h!]\tabularx{\linewidth}{l c c c}}
{\endtabularx\caption{#1}\endtable}
...
\begin{eqntable}{Definition of a truncated cubical set (boxes)}
  ...
  \\
  \eqnline{\mylayer{l}^{n,p,[p < n]}{\begin{array}{l}(D:\partialcubset{l}{n})\\(d:\mybox{l}^{n,p}(D))\end{array}}{:}{\sort{l}}
  \eqnline{\mylayer{l}^{n,p}}{D~d}{\defeq}{\begin{array}{l}\mycube{l}^{n-1,p}(\hd(D))(\tl(D))(\downbox{l,L,p}{n,p}(D)(d)) \\\times\; \mycube{l}^{n-1,p}(\hd(D))(\tl(D))(\downbox{l,R,p}{n,p}(D)(d))\end{array}}
  \\
  \eqnline{\mycube{l}^{n,p,[p \leq n]}}{\begin{array}{l}(D:\partialcubset{l}{n})\\(E:\mycubsetcomp{l}{n}(D))\\(d:\mybox{l}^{n,p}(D))\end{array}}{:}{\sort{l}}
...
\begin{figure*}
  \centerline{ \framebox{$
        \begin{array}{llcl}
          \cohbox{l,\epsilon,\epsilon',q,r}{\!\!\!\begin{array}{l}n,p\\\mbox{}[p \leq r \leq q \leq n - 2]\end{array}}    & \!\!\!\begin{array}{l}(D:\partialcubset{l}{n})\\(d:\mybox{l}^{n,p}(D))\end{array} & :      & \!\!\!\begin{array}{ll}\downbox{l,\epsilon,q}{n-1,p}(\hd(D))(\downbox{l,\epsilon',r}{n,p}(D)(d)) \\ \eqett \downbox{l,\epsilon',r}{n-1,p}(\hd(D))(\downbox{l,\epsilon,q+1}{n,p}(D)(d))\end{array}                                                                             \\
