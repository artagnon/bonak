...
\makeatletter
\let\XKV@setkeys@alt\XKV@setkeys
\long\def\XKV@setkeys[#1]#2{
  \edef\bonak@pfx{\g@addto@macro{\XKV@prefix\XKV@tfam}{@}}
  \edef\bonak@tempa\@empty
  \edef\bonak@keys{}
  \XKV@for@n{\bonak@mask}\bonak@tempa{
    \IfBeginWith{\bonak@tempa}{\bonak@pfx}{
      \XKV@addtolist@n\bonak@keys{\StrBehind{\bonak@tempa}{\bonak@pfx}}}{}
  }
  % Finally, call the real function
  \XKV@setkeys@alt[\bonak@keys]{#2}
}
\makeatother
