...
Since we have formalized the proof in the Coq proof assistant, which implements an intensional type theory, we now present the tables in \emph{intensional} type theory~\cite{martin-lof...,Coq}, leaving implicit some details, which we will explain here, and other details, which we will explain in \ref{sec:mech}.
