...
\usepackage{multirow, minted, tabularx, environ, booktabs, setspace, makecell, caption, xkeyval, xstring, stringstrings, pdflscape}
...
\long\def\bonak@setkeys[#1]#2{
  ...
  \let\XKV@resb\@empty
  \XKV@for@o\XKV@fams\XKV@tfam{
    % Execute even if \bonak@mask is empty
    \XKV@for@eo\bonak@mask\XKV@tempa{
      \substring[e]{\XKV@tempa}{$}{$}
      \XKV@for@o\XKV@na\XKV@tempb{
        \expandafter\XKV@g@tkeyname\XKV@tempb=\@nil\XKV@tempc
        \ifx\XKV@tempc\thestring
        \else
            % Add only the unmasked keys to \XKV@resb
