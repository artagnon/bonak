...
\begin{align*}
  ...
  \seqr{}{\!\!\!\begin{array}{l}\Gamma \vdash A : \Type_m \qquad \Gamma, a:A \vdash B(a) : \Type_m \qquad \Gamma, a:A, b:B(a) \vdash f(a,b):A \\ \Gamma, a:A \vdash D(a) : \Type_m \qquad \Gamma, a:A, d:D(a) \vdash v(a,d) : B(a) \\ \Gamma, a:A, d:D(a) \vdash s(a,d) : D(f(a,v(a,d))) \qquad \Gamma \vdash u : A \qquad \Gamma \vdash w : D(u)\end{array}}{\Gamma \vdash \textsf{cofix}_{a,d,g}^{u,w}\{this:=v(a,d); next:=g(f(a,v(a,d)),s(a,d))\} : Stream_{A,B,f}\, u}                                                                                                                                                       \\
  ...
  \seqr{}{\!\!\!\begin{array}{l}\Gamma \vdash A : \Type_m \qquad \Gamma, a:A \vdash B(a) : \Type_m \qquad \Gamma, a:A, b:B(a) \vdash f(a,b):A \\ \Gamma, a:A \vdash D(a) : \Type_m \qquad \Gamma, a:A, d:D(a) \vdash v(a,d) : B(a) \\ \Gamma, a:A, d:D(a) \vdash s(a,d) : D(f(a,v(a,d))) \qquad \Gamma \vdash u : A \qquad \Gamma \vdash w : D(u)\end{array}}{\!\!\!\begin{array}{r}\Gamma \vdash \textsf{cofix}_{a,d,g}^{u,w}\{this:=v(a,d); next:=g(f(a,v(a,d)),s(a,d))\}.next \equiv \\ \textsf{cofix}_{a,d,g}^{f(u,v(u,w)),s(u,w))}\{this:=v(a,d); next:=g(f(a,v(a,d)),s(a,d))\} \\ : Stream_{A,B,f}\,f(u,v(u,w))\end{array}} \\
\end{align*}
