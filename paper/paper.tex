...
\tabularx{\textwidth}{@{} l X c X @{}}\toprule}
...
\begin{eqntable}{Definition of a truncated cubical set (boxes)}
  ...
  \\
  \eqnline{\mylayer{l}{n,p,[p < n]}}{\shortstack{(D:\partialcubset{l}{n}) \\ (d:\mybox{l}{n,p}(D))}}{:}{\sort{l}}
  \eqnline{\mylayer{l}{n,p}}{D~d}{\defeq}{\shortstack{\mycube{l}{n-1,p}(\hd(D))(\tl(D))(\downbox{l,L,p}{n,p}(D)(d)) \\ \times\; \mycube{l}{n-1,p}(\hd(D))(\tl(D))(\downbox{l,R,p}{n,p}(D)(d))}}
  \\
  \eqnline{\mycube{l}{n,p,[p \leq n]}}{\shortstack{(D:\partialcubset{l}{n}) \\(E:\mycubsetcomp{l}{n}(D)) \\ (d:\mybox{l}{n,p}(D))}}{:}{\sort{l}}
  \eqnline{\mycube{l}{n,p,[p = n]}}{D~E~d}{\defeq}{E.\ensuremath{\mathsf{rel}}(d)}
