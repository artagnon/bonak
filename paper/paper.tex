...
\usepackage{multirow, minted, tabularx, booktabs, setspace, makecell, caption, xkeyval, xstring, xpatch, pdflscape}
...
% More magic: we extend xkeyval with a \appendmask macro to pass to \setkeys
\makeatletter
% The global that stores our mask in prefix@family@key format
\def\bonak@mask{}
