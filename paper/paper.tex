...
\author{Alice Laroche}{Unaffiliated}{alice.laroche@etu.u-paris.fr}{}{}
\author{Valerii Huhnin}{Unaffiliated}{r@artagnon.com}{}{}
\authorrunning{H. Herbelin, R. Ramachandra, A. Laroche, and V. Huhnin}
...
\begin{center}
  \begin{tikzpicture}[scale=2]
    \fill[spanish-blue, pattern=dots] (0, 0) -- (1, 0) -- (1, 1) -- (0, 1) -- (0, 0);
    \fill[spanish-blue, pattern=dots] (0.6, 0.6) -- (1.6, 0.6) -- (1.6, 1.6) -- (0.6, 1.6) -- (0.6, 0.6);
    \draw[raspeberry] (0, 0) -- (1, 0);
    \draw[raspeberry] (1, 1) -- (0, 1);
    \draw[raspeberry] (0.6, 0.6) -- (1.6, 0.6);
    \draw[raspeberry] (1.6, 1.6) -- (0.6, 1.6);
    \draw[spanish-blue] (0, 0) -- (0, 1);
    \draw[spanish-blue] (1, 1) -- (1, 0);
    \draw[spanish-blue] (0.6, 0.6) -- (0.6, 1.6);
    \draw[spanish-blue] (1.6, 1.6) -- (1.6, 0.6);
    ...
    \filldraw[spanish-blue] (0.6, 0.6) circle (1pt);
    \filldraw[spanish-blue] (0.6, 1.6) circle (1pt);
    \filldraw[spanish-blue] (1.6, 1.6) circle (1pt);
    \filldraw[spanish-blue] (1.6, 0.6) circle (1pt);
  \end{tikzpicture}
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \fill[raspeberry, pattern=dots] (1.1, 1.1) -- (1.5, 1.5) -- (1.5, 0.5) -- (1.1, 0.1) -- (1.1, 1.1);
    \fill[raspeberry, pattern=dots] (0.1, 1.1) -- (0.5, 1.5) -- (0.5, 0.5) -- (0.1, 0.1) -- (0.1, 1.1);
    \draw[spanish-blue] (1.1, 1.1) -- (1.5, 1.5);
    \draw[spanish-blue] (0.1, 1.1) -- (0.5, 1.5);
    \draw[spanish-blue] (1.5, 0.5) -- (1.1, 0.1);
    \draw[spanish-blue] (0.5, 0.5) -- (0.1, 0.1);
  \end{tikzpicture}
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \fill[russian-green, pattern=dots] (0.2, 1.1) -- (1.0, 1.1) -- (1.4, 1.5) -- (0.6, 1.5) -- (0.2, 1.1);
    \fill[russian-green, pattern=dots] (0.2, 0.1) -- (1.0, 0.1) -- (1.4, 0.5) -- (0.6, 0.5) -- (0.2, 0.1);
  \end{tikzpicture}
\end{center}

\begin{center}
  \begin{tikzpicture}[scale=2]
    \fill[spanish-blue, pattern=dots] (1.1, 1.1) -- (1.5, 1.5) -- (1.5, 0.5) -- (1.1, 0.1) -- (1.1, 1.1);
    \fill[spanish-blue, pattern=dots] (0.1, 1.1) -- (0.5, 1.5) -- (0.5, 0.5) -- (0.1, 0.1) -- (0.1, 1.1);
    \draw[spanish-blue] (1.1, 1.1) -- (1.1, 0.1);
    \draw[spanish-blue] (0.1, 1.1) -- (0.1, 0.1);
    \draw[spanish-blue] (1.5, 0.5) -- (1.5, 1.5);
    \draw[spanish-blue] (0.5, 0.5) -- (0.5, 1.5);
    \filldraw[spanish-blue] (1.1, 1.1) circle (1pt);
    \filldraw[spanish-blue] (1.5, 1.5) circle (1pt);
    \filldraw[spanish-blue] (1.5, 0.5) circle (1pt);
    \filldraw[spanish-blue] (1.1, 0.1) circle (1pt);
    \filldraw[spanish-blue] (0.1, 1.1) circle (1pt);
    \filldraw[spanish-blue] (0.5, 1.5) circle (1pt);
    \filldraw[spanish-blue] (0.5, 0.5) circle (1pt);
    \filldraw[spanish-blue] (0.1, 0.1) circle (1pt);
  \end{tikzpicture}
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \fill[raspeberry, pattern=dots] (0, 0) -- (1, 0) -- (1, 1) -- (0, 1) -- (0, 0);
    \fill[raspeberry, pattern=dots] (0.6, 0.6) -- (1.6, 0.6) -- (1.6, 1.6) -- (0.6, 1.6) -- (0.6, 0.6);
    \draw[raspeberry] (0, 0) -- (1, 0);
    \draw[raspeberry] (1, 1) -- (0, 1);
    \draw[raspeberry] (0.6, 0.6) -- (1.6, 0.6);
    \draw[raspeberry] (1.6, 1.6) -- (0.6, 1.6);
...
\begin{center}
  ...
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \fill[raspeberry, pattern=dots] (0.2, 1.1) -- (1.0, 1.1) -- (1.4, 1.5) -- (0.6, 1.5) -- (0.2, 1.1);
    \fill[raspeberry, pattern=dots] (0.2, 0.1) -- (1.0, 0.1) -- (1.4, 0.5) -- (0.6, 0.5) -- (0.2, 0.1);
    \draw[raspeberry] (0.2, 1.1) -- (1.0, 1.1);
    \draw[raspeberry] (1.4, 1.5) -- (0.6, 1.5);
    \draw[raspeberry] (0.2, 0.1) -- (1.0, 0.1);
    \draw[raspeberry] (1.4, 0.5) -- (0.6, 0.5);
  \end{tikzpicture}
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \fill[russian-green, pattern=dots] (0, 0) -- (1, 0) -- (1, 1) -- (0, 1) -- (0, 0);
    \fill[spanish-blue, pattern=dots] (0.6, 0.6) -- (1.6, 0.6) -- (1.6, 1.6) -- (0.6, 1.6) -- (0.6, 0.6);
  \end{tikzpicture}
\end{center}
