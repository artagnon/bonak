...
\newcommandx{\restr}[8][2,3,4,5,6,7,8]{
  \ensuremath{\mathsf{\color{russian-green}{restr}}^{
    \joinargs[#2][#3]}_{\joinargs[\mathsf{\color{indian-yellow}{#1}}][#4][#5][#6][#7]}}
  \setkeys*[bonak]{restr#1}{#8}
}

\newcommandx{\refl}[6][2,3,4,5,6]{
  \ensuremath{\mathsf{\color{russian-green}{refl}}^{
    \joinargs[#2][#3]}_{\joinargs[\mathsf{\color{indian-yellow}{#1}}][#4][#5]}}
...
\newcommandx{\cohtwo}[9][2,3,4,5,6,7,8,9]{
  \ensuremath{\mathsf{\color{chestnut}{coh2}}^{
    \joinargs[#2][#3][#4]}_{\joinargs[\mathsf{\color{indian-yellow}{#1}}][#5][#6][#7][#8]}}
  \setkeys*[bonak]{coh2#1}{#9}
}
...
% typesetting
\newcommandx{\framep}[5][1,2,3,4,5]{\prim{frame}[#1][#2][#3][#4][#5]}
\newcommandx{\layer}[5][1,2,3,4,5]{\prim{layer}[#1][#2][#3][#4][#5]}
\newcommandx{\painting}[5][1,2,3,4,5]{\prim{painting}[#1][#2][#3][#4][#5]}
...
\newcommandx{\reflfext}[3][1,2,3]{\refl{frameExt}[#1][#2][][][#3]}
...
\newcommandx{\cohf}[9][1,2,3,4,5,6,7,8,9]{\coh{frame}[#1][#2][#3][#4][#5][#6][#7][#8][#9]}
\newcommandx{\cohl}[9][1,2,3,4,5,6,7,8,9]{\coh{layer}[#1][#2][#3][#4][#5][#6][#7][#8][#9]}
\newcommandx{\cohp}[9][1,2,3,4,5,6,7,8,9]{\coh{painting}[#1][#2][#3][#4][#5][#6][#7][#8][#9]}
...
\appendmask[bonak]{reflpainting}[D, d]
...
% Keep all arguments
\newcommandx{\Xto}[3][3]{\X[<#2][#3]}
\newcommandx{\Xcomp}[3][3]{\X[=#2][#3]}
\newcommandx{\Xfrom}[3][3]{\X[\geq#2][#3]}


% Refl truncated sets.
\newcommandx{\Xreflto}[3][3]{\Xrefl[<#2][#3]}
\newcommandx{\Xreflcomp}[3][3]{\Xrefl[=#2][#3]}
\newcommandx{\Xreflfrom}[3][3]{\Xrefl[\geq#2][#3]}
