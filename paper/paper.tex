...
\newcommandx{\coh}[9][2=,3=,4=,5=,6=,7=,8=,9=]{\ensuremath{\mathsf{\color{chestnut}{coh}}_{\mathsf{\color{indian-yellow}{#1}}, \joinargs[#2][#3][#4][#5][#6]}^{\joinargs[#7][#8][#9]}}}
...
\newcommandx{\cohf}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{frame}[][#2][#3][][][#6][#7][#8]}
\newcommandx{\cohl}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{layer}[][#2][#3][][][#6][#7][#8]}
\newcommandx{\cohc}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{filler}[][#2][#3][][][#6][#7][#8]}
...
\renewcommandx{\framep}[4][1=,2=,3=,4=]{\prim{frame}[][][][]}
\renewcommandx{\layer}[4][1=,2=,3=,4=]{\prim{layer}[][][][]}
\renewcommandx{\filler}[4][1=,2=,3=,4=]{\prim{filler}[][][][]}

% Coherence conditions for frame, layer, and filler
% Drop universe letter, ε, and ω
\renewcommandx{\cohf}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{frame}[][][][#4][#5][#6][#7][#8]}
\renewcommandx{\cohl}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{layer}[][][][#4][#5][#6][#7][#8]}
\renewcommandx{\cohc}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{filler}[][][][#4][#5][#6][#7][#8]}
\input{tab-coh.tex}
...
% Coherence conditions for frame, layer, and filler
\renewcommandx{\cohf}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{cohframe}[#1][#2][#3][#4][#5][#6][#7][#8]}
\renewcommandx{\cohl}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{cohlayer}[#1][#2][#3][#4][#5][#6][#7][#8]}
\renewcommandx{\cohc}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{cohfiller}[#1][#2][#3][#4][#5][#6][#7][#8]}
