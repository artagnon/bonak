...
\begin{equation*}
  \begin{array}{llcl}
    ...
    \begin{array}{l}
      ...
      \restrl[n][p][q][\epsilon](\depscohs[n][\lbrack 0,p-1 \rbrack])(\restrl[n+1][p][r][\omega](\overline{\depscohs}(\depscoht[n][\lbrack 0,p-1 \rbrack]))(l))\\ =_{\cohf[n+1][p][r+1][q+1][\epsilon][\omega](\depscoht[n][\lbrack 0,p-1 \rbrack])} \\
