...
Semi-simplicial sets and semi-cubical sets can be expressed directly in terms of presheaves over a direct category using morphisms, termed as the \emph{fibered form}, or alternatively, we can ``currify'' the presentation using dependent products, termed as the \emph{indexed form}. The indexed variant can also be given for presheaves over a generalised Reedy category, covering the case of simplicial and cubical sets.

In this paper, we focus on simplicial sets equipped with faces and a \emph{cubical-like} form of degeneracy and on cubical sets with faces and degeneracies.
