...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \begin{array}{l}
      ...
      \Pi d:\framep[n+2][p](\overline{\deps}(\fulldepscohs.\depscohs[n][\lbrack 0,p-1 \rbrack])).\,\Pi c:\painting[n+2][p](\overline{\fulldeps}(\fulldepscohs[n])) \\
...
where $\cohttype$ is:
\begin{equation*}
  \cohttype[n][p](\fulldepscohs[n]) \defeq
  \begin{array}{l}
    \Pi q \leq n-p.\,\Pi r \leq q.\,\Pi \epsilon.\,\Pi \omega.\,\Pi \theta.                         \\
    \fulldepscohs.\depscohs.\cohf[n][p][r][0][\omega][\theta](\restrf[n+1][p][q+2][\epsilon]) \circ \\
    \ap\restrf[n][p][r][\omega](\cohf[n+1][p][q+1][0][\epsilon][\theta]
    (\fulldepscoht[n]))
    \circ                                                                                           \\
    \fulldepscohs.\depscohs.\cohf[n][p][q][r][\epsilon][\omega](\restrf[n+1][p][0][\theta]) =       \\
    \ap\restrf[n][p][0][\theta](\cohf[n+1][p][q+1][r+1][\epsilon][\omega]
    (\fulldepscoht[n]))
    \circ                                                                                           \\
    \fulldepscohs.\depscohs.\cohf[n][p][q][0][\epsilon][\theta](\restrf[n+1][p][r+1][\omega])
    \circ                                                                                           \\
