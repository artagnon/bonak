...
\begin{align*}
  ...
  \left(\begin{array}{l}
            ...
            E:\frametype[n-1][n-1]\rightarrow \U         \\
          \end{array}\right)
\end{align*}
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \multicolumn{3}{l}{
      ...
      \restrftype[n][0,...,p]
      \left(\begin{array}{l}
                \fulldeps.\deps.\framep[n][0,...,p]   \\
                \fulldeps.\deps.\painting[n][0,...,p] \\
              \end{array}\right)
    }                                                                                                                                                        \\
    \restrf[n][0,...,0-1]                                                        &
    \left(\begin{array}{l}
    ...
    \begin{array}{l}
        ...
        \begin{array}{l}
            ...
            \painting[n][p](\fulldeps.\deps[n][0,...,n]) \\
            \restrf[n][p]
            \left(\begin{array}{l}
                      \fulldeps.\deps[n][0,...,p] \\
                      \restrp[n][0,...,p-1]       \\
        ...
        \fulldeps.\deps.\layer[n][p](\deps[n][0,...,n])(\restrf[n][p]
        \left(\begin{array}{l}
                  \fulldeps.\deps[n][0,...,p] \\
                  \restrp[n][0,...,p-1]       \\
                  \cohf[n][0,...,p]
  ...
  \begin{array}{llcl}
    ...
    \begin{array}{l}
        ...
        \left(\begin{array}{l}
                ...
                \end{array}\right)(\restrf[n][p](\depscohs[n][0,...,n].deps)(d))\end{array}\right)                                       \\
    \restrp[n][n]                           &
    ...
    \left(\begin{array}{l}
              ...
              (\fulldepscohs[n][0,...,n])(\restrf[n][p](\fulldepscohs.\depscohs[n][0,...,p])(d))(c) \\
            \end{array}\right)                              \\
  \end{array}
\end{equation*}
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \cohptype[n][0,...,p] & (\depscohs[n][0,...,n])                           & \defeq & \cohptype[n+1][0,...,p-1] \times \left(
    \begin{array}{l}
        \Pi q\leq n.\,\Pi r\leq q.\,\Pi \epsilon.\,\Pi \omega. \\
        \depscohs.\restrp[n][p][q][\epsilon](\restrp[n+1][p][r][\omega]
        \left(\begin{array}{l}
                  \depscohs[n+1][0,...,n] \\
                  \cohp[n+1][0,...,p-1]   \\
                \end{array}\right)(d)) =                         \\
        \depscohs.\restrp[n][p][r][\omega](\restrp[n+1][p][q+1][\epsilon]
        \left(\begin{array}{l}
                  \depscohs[n+1][0,...,n] \\
                  \cohp[n+1][0,...,p-1]   \\
                \end{array}\right)(d))
...
We need also the notion of full dependencies at the level of the coherence conditions of dimension 2, that combines a full $\depscoht[n][0,...,n]$ with a set $E:\framep[n][n](\overline{\deps}(\overline{\deps}(\depscohs[n][0,...,n-1])))??? \rightarrow \U$:
\begin{align*}
  \fulldepscohttype[n] \defeq
  \left(\begin{array}{l}
            \depscoht[n][0,...,n-1] :\depscohttype[n][0,...,n-1]    \\
            E:\framep[n-1][n-1](\overline{\deps}(??))\rightarrow \U \\
          \end{array}\right)
\end{align*}
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \left(\begin{array}{l}
              ...
              E                     \\
              E'                    \\
            \end{array}\right)                           & \defeq & \lambda q\leq n.\lambda r\leq q.\lambda \epsilon.\lambda \omega.\lambda d. \lambda (l,c). l\epsilon \\
    \cohp[n][p](p<n)                                   &
    \left(\begin{array}{l}
              \depscoht[n][0,...,n] \\
              E                     \\
              E'                    \\
            \end{array}\right)                           & \defeq & \lambda q\leq n.\lambda r\leq q.\lambda \epsilon.\lambda \omega.\lambda d. \lambda (l,c).
    \left(\begin{array}{l}
              \cohl[n][p][q][\epsilon](\depscoht[n-1][0,...,p-1])(l),            \\
              \cohp[n][p][q][\epsilon]
              \left(\begin{array}{l}
                  \depscoht[n][0,...,n] \\
                  E                     \\
                  E'                    \\
                \end{array}\right)(\cohf[n][p](\depscoht[n][0,...,p])(d))(c) \\
            \end{array}\right)                                                                                         \\
  \end{array}
\end{equation*}
