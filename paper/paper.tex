...
\newcommandx{\refl}[8][2,3,4,5,6,7,8]{
  \ensuremath{\mathsf{\color{russian-green}{refl}}_{
    \joinargs[\mathsf{\color{indian-yellow}{#1}}][#2][#3][#4]}^{\joinargs[#5][#6][#7]}}
  \setkeys*[bonak]{refl#1}{#8}
}
...
\newcommandx{\reflf}[4][1,2,3,4]{\refl{frame}[][#3][#4][#1][#2][][]}
\newcommandx{\refll}[4][1,2,3,4]{\refl{layer}[][#3][#4][#1][#2][][]}
\newcommandx{\reflp}[4][1,2,3,4]{\refl{painting}[][#3][#4][#1][#2][][]}
