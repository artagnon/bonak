...
We previously exploited the observation that semi-simplicial and semi-cubical sets are naturally unary and binary cases of iterated parametricity~\cite{hr25}. In adding a new dimension to our construction, we observed the usual cubical degeneracies in the cubical case and \emph{connections} in the simplicial case. The coherence conditions we used to complete our construction made explicit the ones outlined in Grandis-Mauri~\cite{grandis03}. Our work includes a mechanically-checked formalization in Rocq: \href{https://github.com/artagnon/bonak}{github.com/artagnon/bonak}.

\section{Introduction}

Iterated parametricity à la Reynolds has the property that it mechanically generates augmented simplicial sets in the unary case and cubical sets in the binary (relational) case~\cite{johann17}. This was exploited in \cite{hr25} to describe in a uniform way a construction of both augmented semi-simplicial and cubical sets in indexed form. By \emph{indexed form} is meant that instead of representing simplicial sets (resp. cubical sets) as presheaves over the simplex category (resp. cube category), they are represented as families of dependent families, following an idea presented in~\cite{UFwiki2012}.
...
This paper describes an extension of the construction with degeneracies. On the cubical side, this corresponds to degeneracies in the usual sense of e.g. Grandis and Mauri~\cite{grandis03}. On the simplicial side, this corresponds not to a degeneracy in the usual sense of simplicial sets (such degeneracy would actually take the form of a unary connection, see~\ref{sec:todo}) but to a degeneracy in the senseof parametrici, as in~\cite{bernardy12,bernardy15}. Adding a degeneracy means extending the previous diagram as follows:t
