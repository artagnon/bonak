...
\newcommand{\Xp}[1]{\ensuremath{\mathsf{X}_{#1}}}
\newcommand{\X}[2]{\ensuremath{\mathsf{X}_{#1}^{<#2}}}
\newcommand{\Xcomp}[2]{\ensuremath{\mathsf{X}_{#1}^{=#2}}}
\newcommand{\Xfrom}[2]{\ensuremath{\mathsf{X}_{#1}^{\geq#2}}}

% Frame, layer, and filler
\newcommandx{\prim}[5][2=,3=,4=,5=]{\ensuremath{\mathsf{#1}_{#2}^{\joinargs[#3][#4][#5]}}}
\newcommandx{\framep}[4][1=,2=,3=,4=]{\prim{frame}[#1][#2][#3][#4]}
\newcommandx{\layer}[4][1=,2=,3=,4=]{\prim{layer}[#1][#2][#3][#4]}
\newcommandx{\filler}[4][1=,2=,3=,4=]{\prim{filler}[#1][#2][#3][#4]}

% Full frame
\newcommand{\fullframe}[2]{\ensuremath{\mathsf{fullframe}_{#1}^{#2}}}

% Restriction for frame, layer, and filler
\newcommandx{\restr}[7][2=,3=,4=,5=,6=,7=]{\ensuremath{\mathsf{restr}_{\mathsf{#1}, \joinargs[#2][#3][#4]}^{\joinargs[#5][#6][#7]}}}
\newcommandx{\restrf}[6][1=,2=,3=,4=,5=,6=]{\restr{frame}[#1][#2][#3][#4][#5][#6]}
\newcommandx{\restrl}[6][1=,2=,3=,4=,5=,6=]{\restr{layer}[#1][#2][#3][#4][#5][#6]}
\newcommandx{\restrc}[6][1=,2=,3=,4=,5=,6=]{\restr{filler}[#1][#2][#3][#4][#5][#6]}

% Coherence conditions for frame, layer, and filler
\newcommandx{\coh}[9][2=,3=,4=,5=,6=,7=,8=,9=]{\ensuremath{\mathsf{#1}_{\joinargs[#2][#3][#4][#5][#6]}^{\joinargs[#7][#8][#9]}}}
\newcommandx{\cohframe}[8][1=,2=,3=,4=,5=,6=,7=,8=]{\coh{cohframe}[#1][#2][#3][#4][#5][#6][#7][#8]}
