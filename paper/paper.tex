...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \begin{array}{l}
      ...
      \restrp[n][p][q][\epsilon](\restrf[n+1][p](d))(\restrp[n+1][p][r][\omega]
      (\fulldepscohs[n])(d)(c)) =                                                                                                                    \\
      \restrp[n][p][r][\omega](\restrf[n+1][p](d))(\restrp[n+1][p][q+1][\epsilon]
      (\fulldepscohs[n])(d)(c))
    \end{array}
    \right.                                                                                                                          \\
  \end{array}
...
where $\cohttype$ is:
\begin{equation*}
  \cohttype[n][p](\depscoht[n]) \defeq
  \begin{array}{l}
    \Pi q \leq n-p.\,\Pi r \leq q.\,\Pi \epsilon.\,\Pi \omega.\,\Pi \theta.                                    \\
    \cohf[n][p][r][0][\omega][\theta](\restrf[n+1][p][q+2][\epsilon](\depscohs[n][\lbrack 0,p \rbrack])) \circ \\
    \ap\restrf[n][p][r][\omega](\cohf[n+1][p][q+1][0][\epsilon][\theta]
    (\depscoht[n][p]))
    \circ                                                                                                      \\
    \cohf[n][p][q][r][\epsilon][\omega](\restrf[n+1][p][0][\theta](\depscohs[n][\lbrack 0,p \rbrack])) =       \\
    \ap\restrf[n][p][0][\theta](\cohf[n+1][p][q+1][r+1][\epsilon][\omega]
    (\depscoht[n][p]))
    \circ                                                                                                      \\
    \cohf[n][p][q][0][\epsilon][\theta](\restrf[n+1][p][r+1][\omega](\depscohs[n][\lbrack 0,p \rbrack]))
    \circ                                                                                                      \\
