...
\begin{center}
  ...
  \begin{tikzpicture}[scale=2]
    ...
    \draw[raspeberry, pattern=dots] (0.1, 1.1) -- (0.5, 1.5) -- (0.5, 0.5) -- (0.1, 0.1) -- (0.1, 1.1);
    \draw[raspeberry] (0.3, 0.3) -- (0.3, 1.3);
  \end{tikzpicture}
  \;\;
  \begin{tikzpicture}[scale=2]
    \draw[russian-green, pattern=dots] (0.2, 1.1) -- (1.0, 1.1) -- (1.4, 1.5) -- (0.6, 1.5) -- (0.2, 1.1);
    \draw[russian-green, pattern=dots] (0.2, 0.1) -- (1.0, 0.1) -- (1.4, 0.5) -- (0.6, 0.5) -- (0.2, 0.1);
  \end{tikzpicture}
\end{center}
