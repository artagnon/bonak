...
It is also convenient to build $\depscohs$ from $\depscohtt$ at the previous level:

\begin{align*}
  \overline{\depscohs}(\depscoht:\depscohttype) & :      & \depscohstype \\
  \overline{\depscohs}(\depscoht)               & \defeq &
  \left(\begin{array}{l}
            \overline{\deps}[n][p](\depscoht.\fulldepscohs.\depcohs[n][0,...,p])   \\
            \restrpainting[n][p](\depscoht.\fulldepscohs[n][0,...,n]) \\
