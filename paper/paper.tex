...
\end{align*}
Note: a possible alternative notation for $Stream_{A,B,f}$ could be $\Sigma^X_{u:A} b:B(u). X(f(u,b))$. That would be closer from the notation in Table 1.
