...
\begin{center}
  \begin{tikzpicture}[scale=2]
    \filldraw[spanish-blue, pattern=dots] (0, 0) -- (1, 0) -- (1, 1) -- (0, 1) -- (0, 0);
    \filldraw[spanish-blue, pattern=dots] (0.6, 0.6) -- (1.6, 0.6) -- (1.6, 1.6) -- (0.6, 1.6) -- (0.6, 0.6);
  ...
  \;\;\;\;
  \begin{tikzpicture}[scale=2]
    \draw[raspeberry] (1.1, 1.1) -- (1.5, 1.5);
    \draw[raspeberry] (0.1, 1.1) -- (0.5, 1.5);
    \draw[raspeberry] (1.5, 0.5) -- (1.1, 0.1);
    \draw[raspeberry] (0.5, 0.5) -- (0.1, 0.1);
