...
\begin{tabularx}{\linewidth}{lYcYYl}
  \toprule
  arity                     & formalisation style          & iteration                       & relevance                     & logical structure    \\
  \midrule
  \multirow{6}{1cm}{unary}  & \multirow{3}{1.5cm}{indexed} & \multirow{2}{2cm}{non-iterated} & proof-irrelevant              & predicate            \\
                            &                              &                                 & relevant                      & family               \\
  ...
  \midrule
  \multirow{6}{1cm}{binary} & \multirow{3}{1.5cm}{indexed} & \multirow{2}{2cm}{non-iterated} & proof-irrelevant              & relation             \\
