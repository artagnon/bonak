...
Our construction has the unique property of reflecting the structure of parametricity and of generically yielding augmented semi-simplicial and semi-cubical sets, although it is not able to take benefit of the definitional compositionality of increasing injective functions present in \cite{part15} and \cite{altenkirch16}.
