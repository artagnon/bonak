...
\def\bonak@appendmask[#1]{
  \XKV@addtolist@n\bonak@mask{\XKV@header#1}
}
\def\appendmask{\XKV@testopta{\XKV@testoptc\bonak@appendmask}}

% Now we patch \XKV@setkeys
\xpretocmd{\XKV@setkeys}{
  \XKV@for@n{\bonak@mask}\XKV@tempa{
    \IfBeginWith{\XKV@tempa}{\XKV@header}{
      \XKV@addtolist@n\XKV@na{\StrBehind{\XKV@tempa}{\XKV@header}}}{}
  }
}{\tracingpatches}{\tracingpatches}
\xpatchcmd{\XKV@setkeys}{{#1}}{{\XKV@na}}{\tracingpatches}{\tracingpatches}
\makeatother
