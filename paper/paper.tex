...
\newcommandx*{\X}[3][1=,2=,3=]{\ensuremath{
  \begingroup
...
\newcommandx*{\prim}[6][2=,3=,4=,5=,6=]{\ensuremath{
  \begingroup
    \mathsf{\color{indian-yellow}{#1}}_{#2}^{\joinargs{}[#3][#4][#5]}
    \setkeys*[prim]{#1}{#6}
  \endgroup
}}

% Restriction for frame, layer, and filler: the general macro
\newcommandx*{\restr}[8][2=,3=,4=,5=,6=,7=,8=]{\ensuremath{
  \begingroup
    \mathsf{\color{russian-green}{restr}}_{\mathsf{\color{indian-yellow}{#1}}
...
\newcommandx*{\coh}[9][2=,3=,4=,5=,6=,7=,8=,9=]{\ensuremath{
  \begingroup
    \mathsf{\color{chestnut}{coh}}_{\mathsf{\color{indian-yellow}{#1}}
