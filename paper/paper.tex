...
%\newcommand{\cubeovername}{cubeover}
%\newcommand{\Cubeovername}{Cubeover}
...
%\newcommand{\heteroofliftbox}[3]{\mathsf{subliftBox}_{#1}^{#2,#3}}
%\newcommand{\heteroofliftlayer}[3]{\mathsf{subliftLayer}_{#1}^{#2,#3}}
%\newcommand{\heteroofliftcube}[3]{\mathsf{subliftCube}_{#1}^{#2,#3}}
...
%\newcommand{\downcubeleft}{\mathsf{sub\cubeovername}^L}
%\newcommand{\downcuberight}{\mathsf{sub\cubeovername}^R}
...
%\newcommand{\downboxtypelarge}[1]{\mathsf{Subbox'}_{#1}}
...
%\newcommand{\cohboxtypelarge}[1]{\mathsf{Cohbox'}_{#1}}
...
When reflexivities are excepted, we call the structure thus defined
\emph{bare truncated cubical sets}: \emph{bare} because it can be seen
as defining a cubical equivalent to semi-simplicial sets with only
faces as part of the structure (otherwise said, another terminology
could have been ``semi-cubical'' sets); \emph{truncated} because we
consider only such cubical sets up to some fixed dimension.
...
\begin{small}
\begin{array}{llcl}
\cohbox{l,\epsilon,\epsilon',q,r}{\!\!\!\tiny\begin{array}{l}n,p\\\mbox{}[p \leq r < q < n]\end{array}} & \!\!\!\begin{array}{l}(D:\partialcubset{l}{n})\\(d:\mybox{l}^{n,p}(D))\end{array}& : & \!\!\!\begin{array}{ll}\downbox{l,\epsilon,q-1}{n-1,p}(\hd(D))(\downbox{l,\epsilon',r}{n,p}(D)(d)) \\ \eqett \downbox{l,\epsilon',r-1}{n-1,p}(\hd(D))(\downbox{l,\epsilon,q}{n,p}(D)(d))\end{array}\\
...
\\
\cohlayer{l,\epsilon,\epsilon',q,r}{\!\!\!\tiny\begin{array}{l}n,p\\\mbox{}[p < r < q < n]\end{array}} & \!\!\!\begin{array}{l}(D:\partialcubset{l}{n})\\(d:\mybox{l}^{n,p}(D))\\(b:\mylayer{l}^{n,p}(D)(d))\end{array}& : & \!\!\!\begin{array}{ll}\downlayer{l,\epsilon,q}{n-1,p}(\hd(D))(\downbox{l,\epsilon',r}{n,p}(D)(d))(\downlayer{l,\epsilon',r}{n,p}(D)(d)(b)) \\ \eqett \downlayer{l,\epsilon',r}{n-1,p}(\hd(D))(\downbox{l,\epsilon,q}{n,p}(D)(d))(\downlayer{l,\epsilon,q}{n,p}(D)(d)(b))\end{array}\\
...
\\
\cohcube{l,\epsilon,\epsilon',q,r}{\!\!\!\tiny\begin{array}{l}n,p\\\mbox{}[p \leq r < q < n]\end{array}} & \!\!\!\begin{array}{l}(D:\partialcubset{l}{n})\\(E:\mycubsetcomp{l}{n}(D))\\(d:\mybox{l}^{n,p}(D))\\(b:\mycube{l}^{n,p}(D)(E)(d))\end{array}& : & \!\!\!\begin{array}{ll}\downcube{l,\epsilon,q-1}{n-1,p}(\hd(D))(\tl(D))(\downbox{l,\epsilon',r}{n,p}(D)(d))(\downcube{l,\epsilon',r}{n,p}(D)(E)(d)(b)) \\ \eqett \downcube{l,\epsilon',r-1}{n-1,p}(\hd(D))(\tl(D))(\downbox{l,\epsilon,q}{n,p}(D)(d))(\downcube{l,\epsilon,q}{n,p}(D)(E)(d)(b))\end{array}\\
...
we can define on Figures~\ref{fig:macros} and~\ref{fig:macroscont} a few other concepts at a
...
$\myfullbox{l}^{n}(D_{n})$ for $D_{n} \defeq (A,=_A,...,=^n_A)$ the initial
...
associated to the left. For cubes, the components can be associated to
the left, and we call this a full $n$-cube or to the right, which we
call grounded $n$-cube, and which corresponds to ``complete'' partial
cubes, i.e. to partial cubes over the empty
box. Figure~\ref{fig:macros} show how to compute the $n$-box
surrounding a full $n$-cube over a prefix $D_{n+1}$ of iterated
equalities (see $\border{}$).
