    ...
    \begin{array}{ll}
      ...
      X_2                                : \underbrace{\Sigma a: \underbrace{\left(\Sigma \unitpoint: \unittype. \underbrace{\left(
          \begin{array}{c}
            ...
            \right).\, \underbrace{X_1 \underbrace{(\unitpoint, b)}_{\restrf[2][1][L][0]}}_{\painting[1][1]}}_{\painting[1][0]}
            \\ \times \\
            \underbrace{\Sigma b: \left(
            \hspace{-0.4em}\begin{array}{c}
                             X_0(\unitpoint)
                             ...
                             X_0(\unitpoint)
                           \end{array}\hspace{-0.4em}
            \right).\, \underbrace{X_1 \underbrace{(\unitpoint, b)}_{\restrf[2][1][R][0]}}_{\painting[1][1]}}_{\painting[1][0]}
          \end{array}
