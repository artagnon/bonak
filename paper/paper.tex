...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \deps[n][\lbrack 0,p \rbrack]
                                          & \defeq &
    d \mapsto \Pi\epsilon.\,\painting[n][p](\deps.\restrf[n][p][0][\epsilon](d))                                         \\
  \end{array}
\end{equation*}
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    \painting[n+1][p]               &
    (\fulldeps[n]:\fulldepstype[n]) & :      & \paintingtype[n+1][p]      \\
    \painting[n+1][n+1]             &
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \begin{array}{l}
        \Pi q \leq n-p.\Pi \epsilon.\Pi d:\framep[n+1][p](\fulldeps.\deps[n][\lbrack 0,p-1 \rbrack]). \\
        \painting[n+1][p]
  ...
  \begin{array}{llcl}
    ...
    \left\{\begin{array}{l}
             ...
             \left(\begin{array}{l}
                ...
                \restrp[n][\lbrack 0,p-1 \rbrack] \\
              \end{array}\right).                  \\
             \Pi q \leq n-p.\,\Pi r\leq q.\,\Pi \epsilon.\,\Pi \omega.\,\Pi d:\framep[n+2][p]
    ...
    \restrl[n][p]                           &
    \depscohs[n][\lbrack 0,p \rbrack]       & \defeq                              &
    \lambda q \leq n-p. \lambda \epsilon.\,\lambda d.\lambda l.\overrightarrow{\cohf[n][p][q][q][\epsilon][\omega](d)}{\restrp[n][p][q][\epsilon](\restrf[n][p][q][\epsilon](\depscohs[n][\lbrack 0,p-1 \rbrack])(d))(l \omega)} \\
  \end{array}
\end{equation*}
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \left(
    \begin{array}{l}
        \Pi q \leq n-p. \Pi \epsilon. \Pi d:\framep[n+2][p]
    ...
    \restrp[n+1][n+1]                       &
    (\fulldepscohs[n])                      & \defeq & \lambda q \leq n-p.\lambda \epsilon. \lambda d. \lambda (l,c). l\epsilon \\
    \restrp[n+1][p \leq n]                  &
    (\fulldepscohs[n])                      & \defeq & \lambda q \leq n-p.\lambda \epsilon. \lambda d. \lambda (l,c).
    \left(\begin{array}{l}
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \cohptype[n][\lbrack 0,p \rbrack]   & (\fulldepscohs[n])                      & \defeq & \cohptype[n][\lbrack 0,p-1 \rbrack](\fulldepscohs[n]) \times \\
                                        &                                         &        & \;\;\;\;\left\{
    \begin{array}{l}
      \Pi q \leq n-p.\,\Pi r\leq q.\,\Pi \epsilon.\,\Pi \omega.\,\Pi d:\framep[n+2][p](\overline{\deps}(\fulldepscohs.\depscohs[n][\lbrack 0,p-1 \rbrack])).\,\Pi c:\painting[n+2][p](\overline{\fulldeps}(\fulldepscohs[n])) \\
  ...
  \begin{array}{llcl}
    ...
    \left(\begin{array}{l}
              ...
              \left(\begin{array}{l}
                ...
                \end{array}\right).                                    \\
              \Pi q \leq n - p.\,\Pi r\leq q.\,\Pi \epsilon.\,\Pi \omega.\,\Pi \theta.\, \\
...
\begin{equation*}
  ...
  \begin{array}{llcl}
    ...
    \cohp[n+1][n+1]                         &
    (\fulldepscoht[n])
                                            & \defeq & \lambda q \leq n-p.\lambda r\leq q.\lambda \epsilon.\lambda \omega.\lambda d. \lambda (l,c). l\epsilon \\
    \cohp[n+1][p \leq n]                    &
    (\fulldepscoht[n])
                                            & \defeq & \lambda q \leq n-p.\lambda r\leq q.\lambda \epsilon.\lambda \omega.\lambda d. \lambda (l,c).
    \left(\begin{array}{l}
...
From which we can deduce $\cohp[n+1][\lbrack 0,p-1 \rbrack]$ for $p \leq n+2$ again by a second recursion, this time on $p$:
...
\begin{align*}
  \rotatebox[origin=c]{90}{\depscohs[n][\lbrack 0,n-1 \rbrack]}
  \begin{cases}
    \rotatebox[origin=c]{90}{\deps[n][\lbrack 0,n-1 \rbrack]}
    \begin{cases}
...
\begin{itemize}
  ...
  \item $\cohp[n+1][\lbrack 0,n \rbrack]$ assuming $E'$ and $E'': \framep[n+3][n+2](\overline{\deps}(\overline{\depscohs}(\depscoht[n][\lbrack 0,n-1 \rbrack]))) \rightarrow \U$ comes from $\fulldepscoht[n]$ which holds by assumptions (additionally using $E''$)
\end{itemize}
