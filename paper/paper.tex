...
The fibered representation can be drawn as:
\begin{equation*}
  \begin{tikzcd}
...
The indexed representation can be drawn as:
\begin{align*}
  X_0 & : \U{}                                                                                                      \\
