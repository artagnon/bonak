...
\usepackage{multirow, float, tabularx, environ, booktabs, setspace, makecell, caption, art.cls/joinargs, colortbl, multicol, pdflscape, minted}
...
\begin{align*}
  \framep[n][p](D) & \defeq & \Sigma a_n : (\ldots (\Sigma \unitpoint : \unittype .        \\
                   &        & \layer[n][0](D)) \ldots) .\; \layer[n][p](D)                 \\
