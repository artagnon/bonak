...
For instance, in the case of a semi-cubical set, presented with $2n$ face maps from the set of $n$-cubes to the set of $(n-1)$-cubes, the standard presheaf approach prescribes a family of sets fibered the ones over the others (up to coherence conditions such). Formulated in type theory, it corresponds to:
