...
\begin{align*}
  \depscohs[n][p]\begin{cases}
                   \deps[n][p]\begin{cases}
              ...
              \end{array}\right)
               \end{cases} \\
                   \restrp[n][0,...,n-1](E:\framep[n+1][n]
                   \left(\begin{array}{l}
              \framep[n][0,...,n-1]   \\
              \painting[n][0,...,n-1] \\
              \restrf[n][0,...,n-1]   \\
            \end{array}\right)\rightarrow \U) & : \restrptype[n][0,...,n-1]
                   \left(\begin{array}{l}
              \framep[n][0,...,n-1]   \\
              \painting[n][0,...,n-1] \\
              \restrf[n][0,...,n-1]   \\
              E                       \\
            \end{array}\right)                                                             \\
                   \cohf[n][0,...,n-1](E:\framep[n+1][n]
                   \left(\begin{array}{l}
              \framep[n][0,...,n-1]   \\
              \painting[n][0,...,n-1] \\
              \restrf[n][0,...,n-1]   \\
            \end{array}\right)\rightarrow \U) & : \cohftype[n][0,...,n-1]
                   \left(\begin{array}{l}
              \framep[n][0,...,n-1]   \\
              \painting[n][0,...,n-1] \\
              \restrf[n][0,...,n-1]   \\
