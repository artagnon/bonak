...
Equations specifying $\nu$-sets in indexed form were given, and the well-foundedness of the construction was by induction on large structure involving equational reasoning, in the previous work. The current work presents a refined construction which expresses the computational recursive essence of the construction.
