...
%\newcommand{\tmu}{{}}  % no sign
\newcommand{\muof}[2]{{\mu #1.#2}}
%\newcommand{\muof}[2]{{#2.#1}}
...
%\newcommand{\rawletin}{\mathbf{let-in}}
...
%\newcommand{\lbdminus}[2]{\backslash #1.#2}
%\newcommand{\lbdminus}[2]{\bbslash #1.#2}
\newcommand{\lbdminus}[2]{\tilde\lambda #1.#2}
\newcommand{\lbdminusl}[2]{\l_1 #1.#2}
\newcommand{\lbdminusr}[2]{\l_2 #1.#2}
%\newcommand{\consminus}[2]{#1 \cdot #2}
%\newcommand{\consminus}[2]{#2 \;{\tilde\cdot}\; #1}
