...
frame^{n-1,k\geq p} \arrow[d] \arrow[ddr] & & & frame^{n-1,p} \arrow[d] \arrow[ddr]\\
...
\item To rely on frame$^{n-2,k\geq p}$, painting$^{n-2,k\geq p}$ and
  restrframe$^{n-1,k\geq p}$ to build frame$^{n-1,k\geq p}$ and
